...
function checkCollision(rock) {
  ...
  if (top > 360) {
    ...
    if (((dodgerLeftEdge < rockLeftEdge) && (rockLeftEdge < dodgerRightEdge)) || ((dodgerLeftEdge < rockRightEdge) && (rockRightEdge < dodgerRightEdge))) {
      return true;
    } else {
      return false;
    }
...
function moveDodgerLeft() {
  ...
  function updateLeft() {
    if (left >= 4) {
      ...
      console.log(DODGER.style.left, DODGER.style.right);
